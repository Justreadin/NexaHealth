...
const PILViewer = {
    ...
    fetchPilDetails: async function(pilId) {
        ...
        const response = await fetch(`http://localhost:8000/api/pils/${pilId}`, {
            headers: {
    ...
    recordView: async function(pilId) {
        ...
        try {
            await fetch(`http://localhost:8000/api/pils/${pilId}/view`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
    ...
    toggleSave: async function() {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8000/api/pils/${this.currentPilId}/save`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
    ...
    download: function() {
        if (!this.currentPilId) return;
        window.open(`http://localhost:8000/api/pils/${this.currentPilId}/download`, '_blank');
    },
    ...
    checkIfSaved: async function(pilId) {
        try {
            ...
            const response = await fetch('http://localhost:8000/api/pils/saved', {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
